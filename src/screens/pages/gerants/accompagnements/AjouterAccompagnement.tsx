...
interface AjouterAccompagnementProps {
...
const AjouterAccompagnement = ({onCancel,onSave, isVisible}:AjouterAccompagnementProps) => {

  return (
    <BottomSheetComponent title="Ajouter un accompagnement" isVisible={isVisible} onCancel={onCancel} onSave={onSave} btnTitle='Ajouter'>
...
export default AjouterAccompagnement
