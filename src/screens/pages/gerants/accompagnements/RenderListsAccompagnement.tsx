...
const RenderListAccompagnement = ({item}:any) => {
  ...
  return (
    ...
    onPress={()=>navigation.navigate({name:"DetailsAccompagnement",params:item}as never)}
    >
        <View>
...
export default RenderListAccompagnement
