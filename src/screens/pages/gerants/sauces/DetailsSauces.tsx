...
const DetailsSauces = ({route}: any) => {
  ...
  return (
    <View style={{height: Dimensions.get('screen').height}}>
      ...
      <ModalComponent
        title="SUPPRESSION DE LA SAUCE"
        subtitle="Attention, vous êtes sur le point de supprimer une sauce. Etes vous sûr de vouloir conntinuer ?"
