...
interface AjouterGarnituresProps {
...
const AjouterGarnitures = ({onCancel,onSave, isVisible}:AjouterGarnituresProps) => {

  return (
    <BottomSheetComponent title="Ajouter une garniture" isVisible={isVisible} onCancel={onCancel} onSave={onSave} btnTitle='Ajouter'>
...
export default AjouterGarnitures
