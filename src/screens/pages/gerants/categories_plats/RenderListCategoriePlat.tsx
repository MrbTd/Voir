...
const RenderListCategoriePlat = ({item}:any) => {
  ...
  return (
    ...
    onPress={()=>navigation.navigate({name:"DetailsCategoriePlat",params:item}as never)}
    >
        <View>
            <Image source={imageRessource.eat} style={{width:90,height:100,resizeMode:"center",borderTopLeftRadius:8,borderBottomLeftRadius:8}}/>
        </View>
