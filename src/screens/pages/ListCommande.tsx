import { StyleSheet, FlatList, TouchableOpacity, View, ImageBackground, Image, Dimensions } from 'react-native'
    ...
    <View style={{flex:1}}>
      ...
      <View>
        <ImageBackground source={imageRessource.pattern} style={{height:200}}>
                  {status!=="cuisine"&&<View style={{flexDirection:"row",justifyContent:"space-between",marginHorizontal:"5%",padding:"2%",marginTop:'5%',alignItems:"center"}}>
                    ...
                    <CustomText fontSize={18} fontWeight='bold' color={paletteColor.white} onPress={()=>navigation.navigate("Home"as never)}>ACCUEIL</CustomText>
                  </View>}
                    {status=="cuisine"&& <View style={{flexDirection:"row",justifyContent:"space-between",marginHorizontal:"5%",backgroundColor:paletteColor.white,padding:"2%",borderTopLeftRadius:50,borderBottomLeftRadius:50,borderTopRightRadius:50,borderBottomRightRadius:50,marginTop:'5%',alignItems:"center"}}>
...
{status=="cuisine"&& <View style={{  position: 'absolute', zIndex: 100, bottom: -20,width:"80%",left:"10%" }}>
                    <CustomButton
            ...
            {status!=="cuisine"&&<View style={{flexDirection:"row",justifyContent:"space-around",marginTop:"5%"}}>
                <View style={{width:"40%"}}>
                  <CustomButton label='En cours' disabled={true}/>
                </View>
                <TouchableOpacity style={{borderRadius:8,borderWidth:3,padding:10,borderColor:paletteColor.marron,width:"40%",justifyContent:"center",alignItems:"center"}}  activeOpacity={.7} onPress={()=>navigation.navigate("ListMesCommande" as never)}>
                  <CustomText textAlign='center' color={paletteColor.marron}>Mes Commandes</CustomText>
                </TouchableOpacity>
            </View>}
      </View>
        <View style={{flex:1,marginHorizontal:"5%",marginTop:"8%"}}>
            ...
            renderItem={({item})=>
              <TouchableOpacity style={{borderWidth:3,borderRadius:8,borderColor:paletteColor.marron,marginVertical:"2%",padding:"4%"}} onPress={()=>navigation.navigate("DetailsCommande" as never)}>
